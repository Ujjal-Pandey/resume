...
const About = () => {
  return (
    <section
      id="about"
      className="py-16 bg-slate-900 relative overflow-hidden scroll-mt-16"
    >
          ...
          >
            <div>
              <h3 className="text-3xl font-bold mb-4 text-white">
                I'm <span className="text-cyan-400">Ujjal Pandey</span>
              </h3>
              <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-purple-500 mb-6"></div>
              <p className="text-gray-300 text-lg leading-relaxed">
                A passionate{" "}
                <strong className="text-cyan-400">Full Stack Developer</strong>{" "}
                currently studying{" "}
                <strong className="text-cyan-400">
                  CSIT at Butwal Multiple Campus
                </strong>
              ...
              {[
                {
                  ...
                  title: "Education",
                  desc: "CSIT Student",
                  subDesc: "Butwal Multiple Campus",
                },
                {
                  icon: "💻",
                  title: "Experience",
                  desc: "2+ Years Coding",
                  subDesc: "Full Stack Focus",
                },
                {
                  icon: "🚀",
                  title: "Projects",
