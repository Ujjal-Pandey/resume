...
const Skills = () => {
  return (
    <section
      id="skills"
      className="py-16 bg-gradient-to-b from-black via-slate-900 to-slate-800 scroll-mt-16 relative overflow-hidden"
    >
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto mt-4">
            Technologies & tools I master to build amazing apps
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              ...
              whileHover={{
                y: -10,
                boxShadow: `0 25px 50px rgba(${category.color === "cyan" ? "34, 211, 238" : category.color === "green" ? "74, 222, 128" : "168, 85, 247"}, 0.2)`,
              }}
            ...
            >
              ...
              <h3
                className={`text-2xl font-bold mb-6 text-${category.color === "cyan" ? "cyan" : category.color === "green" ? "green" : "purple"}-400`}
              >
                {category.title}
              </h3>
